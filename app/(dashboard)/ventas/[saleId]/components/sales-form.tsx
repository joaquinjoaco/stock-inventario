...
const formSchema = z.object({
    // id is autogenerated.
    totalPrice: z.coerce.number().gte(0, { message: 'Debes ingresar una cantidad válida' }), // coerce because we are using a decimal
                                        ...
                                        <FormControl>
                                            <Card className="shadow-none">
                                                <CardHeader>
                                                    ...
                                                    <CardDescription>
                                                        Selecciona el método de pago que usará el cliente. {watch('paymentType')}
                                                    </CardDescription>
                                                </CardHeader>
