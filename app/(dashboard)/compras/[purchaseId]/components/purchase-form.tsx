        ...
        <>
            <AlertModal
                ...
                description={<>Se eliminará la compra, esta acción es destructiva y no se puede deshacer.
                    ...
                    <br />
                    <br />
                    Esta compra sumó {initialData?.amount ? initialData.amount.toString() : ''} al stock del producto.</>}
                ...
                <form id="purchase-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input disabled={loading || disabled} placeholder="Proveedor del producto" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="number" disabled={loading || disabled} placeholder="Cantidad adquirida" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>Costo total (UYU)</FormLabel>
                                    <FormControl>
                                        <Input type="number" disabled={loading || disabled} placeholder="Costo total en UYU" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
